...
error_reporting(0);
  ...
  if(isset($_POST["update_invoice"]))
  {
    $order_total_before_tax = 0;
      ...
      $statement = $connect->prepare("
                DELETE FROM quotation_item WHERE order_id = :order_id
            ");
            $statement->execute(
                array(
                    ':order_id'       =>      $order_id
  ...
  {
    $statement = $connect->prepare("DELETE FROM quotation_order WHERE order_id = :id");
    $statement->execute(
      array(
        ':id'       =>      $_GET["id"]
      )
    ...
    $statement = $connect->prepare(
      "DELETE FROM quotation_item WHERE order_id = :id");
    $statement->execute(
      array(
        ':id'       =>      $_GET["id"]
      )
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            <tr>
                <td colspan="2">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                     <span style="color:red">*Quotation No Should not be Same</span><br />
                ...
                <td colspan="2">
                  ...
                  <table id="invoice-item-table" class="table table-bordered">
                    <tr>
                      ...
                      <th >Price</th>
                      <th >Actual Amt.</th>
                      <!--<th width="12.5%" colspan="2" style="display:none;">Tax1 (%)</th>
                      <th width="12.5%" colspan="2" style="display:none;">Tax2 (%)</th>
                      <th width="12.5%" colspan="2" style="display:none;">Tax3 (%)</th>-->
                      <th >Total</th>
                      <!--<th ></th>-->
                    </tr>
                    <!--<tr >
      ...
      <br />
      <div align="right">
		<a href="invoice.php" class="btn btn-info btn-xs big">For Invoice</a><br>
        <a href="quotation.php?add=1" class="btn btn-info btn-xs big big2">Create New Quotation</a>
      </div>
      <br />
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="print_quotation.php?pdf=1&id='.$row["order_id"].'">PDF</a></td>
                <td><a href="quotation.php?update=1&id='.$row["order_id"].'">EDIT</a></td>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click', '.delete', function(){
      ...
      {
        window.location.href="quotation.php?delete=1&id="+id;
      }
      else
      {
        return false;
