...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
            ...
            <tr>
                <td colspan="2">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                    <span style="color:red">*Invoice No Should not be Same</span><br />
      ...
      {
      ?>
      <h3 align="center">CASH BILL</h3>

      <br />
      <div align="right">
		 <a href="quotation.php" class="btn btn-info btn-xs big">For Quotation</a><br>
        <a href="invoice.php?add=1" class="btn btn-info btn-xs big big2">Create New Bill</a>
      </div>
      <br />
